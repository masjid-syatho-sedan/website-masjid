...
<body>
    ...
    <aside class="sidebar" id="sidebar">
            ...
            <a href="{{ route('dashboard') }}" wire:navigate class="sidebar-brand">
                <div class="brand-icon">
                    <svg width="20" height="20" fill="#78350f" viewBox="0 0 24 24">
                        <path
                            d="M6 19V9.5C6 8.1 7.1 7 8.5 7H10V5c0-1.1.9-2 2-2s2 .9 2 2v2h1.5C16.9 7 18 8.1 18 9.5V19H6zm4-6h4v-2h-4v2zm0 4h4v-2h-4v2z" />
                    </svg>
                </div>
        ...
        <nav class="sidebar-nav">
            ...
            <p class="nav-section" style="margin-top:12px;">Konten</p>
        ...
        <div class="sidebar-bottom">
            ...
            <a href="{{ route('portal.artikel.index') }}" wire:navigate
                class="nav-item {{ request()->routeIs('portal.artikel.*') ? 'active' : '' }}">
                <span class="nav-icon">
                    <svg width="16" height="16" fill="none" stroke="rgba(254,243,199,0.9)" stroke-width="2"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="main-wrapper">
        ...
        <header class="mobile-header">
            ...
            <div style="display:flex;align-items:center;gap:8px;">
                <div
                    style="width:28px;height:28px;border-radius:8px;background:linear-gradient(135deg,#fde68a,#f59e0b);display:flex;align-items:center;justify-content:center;">
                    <svg width="15" height="15" fill="#78350f" viewBox="0 0 24 24">
                        <path
                            d="M6 19V9.5C6 8.1 7.1 7 8.5 7H10V5c0-1.1.9-2 2-2s2 .9 2 2v2h1.5C16.9 7 18 8.1 18 9.5V19H6z" />
                    </svg>
                </div>
            ...
            <flux:dropdown position="top" align="end">
                <button
                    style="background:rgba(255,255,255,0.1);border:none;border-radius:10px;padding:4px 8px;cursor:pointer;display:flex;align-items:center;gap:6px;">
                    <div class="avatar-ring">
                        <div class="avatar-inner" style="width:26px;height:26px;font-size:0.65rem;">
                            {{ auth()->user()->initials() }}
                        </div>
                    </div>
                    <svg width="12" height="12" fill="none" stroke="rgba(253,230,138,0.8)"
                ...
                <flux:menu class="border border-amber-200 shadow-2xl rounded-xl overflow-hidden min-w-52">
                    <div
                        style="display:flex;align-items:center;gap:10px;padding:12px;background:linear-gradient(to right,#fffbeb,#fef9c3);border-bottom:1px solid #fde68a;">
                        <div class="avatar-ring">
                            <div class="avatar-inner">{{ auth()->user()->initials() }}</div>
                        </div>
                        <div style="min-width:0;">
                            <p
                                style="color:#78350f;font-weight:600;font-size:0.85rem;margin:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                                {{ auth()->user()->name }}</p>
                            <p
                                style="color:#b45309;font-size:0.72rem;margin:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                                {{ auth()->user()->email }}</p>
                        </div>
                    </div>
                    <flux:menu.radio.group>
