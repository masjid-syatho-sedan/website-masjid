    ...
    <form wire:submit="simpan" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-amber-100 shadow-sm p-5">
                ...
                <input type="hidden" id="trix_konten_edit" wire:model="konten">
                <trix-editor input="trix_konten_edit" class="trix-content rounded-xl border border-amber-200 focus:border-amber-500 focus:ring-1 focus:ring-amber-300" style="min-height: 400px;"></trix-editor>
