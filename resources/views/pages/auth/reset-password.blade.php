<x-layouts::base :title="'Reset Kata Sandi'" active="portal">
    <style>
        ...
        * { font-family: 'Poppins', sans-serif; }
        ...
        .back-link {
            ...
            font-size: 0.875rem; color: var(--teks-ringan);
        }
        ...
        .back-link a:hover {
            color: var(--warna-utama-gelap); text-decoration: underline;
        }
        ...
        <div class="auth-wrapper">
            <div class="auth-card">
                ...
                <form method="POST" action="{{ route('password.update') }}" class="auth-form">
                    ...
                    <button type="submit" class="submit-btn" data-test="reset-password-button">
                        Reset Kata Sandi
                    </button>
                </form>

                <div class="back-link">
                    Kembali ke <a href="{{ route('login') }}" wire:navigate>halaman masuk</a>
                </div>
            </div>
        </div>
    </div>
